...
Compositor::CompositorSignalType& Compositor::ObjectAddedSignal()
{
  return GetImplementation(*this).ObjectAddedSignal();
}

Compositor::CompositorSignalType& Compositor::ObjectDeletedSignal()
{
  return GetImplementation(*this).ObjectDeletedSignal();
}
