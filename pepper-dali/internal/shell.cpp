...
{
  GetImplementation( *this ).Configure( width, height, callback, data );
}

void Shell::CreateClient( wl_client* client, unsigned int version, unsigned int id )
{
  GetImplementation( *this ).CreateClient( client, version, id );
}

void Shell::GetSurface( wl_client* client, unsigned int id, wl_resource* surfaceResource )
{
  GetImplementation( *this ).GetSurface( client, id, surfaceResource );
}
...
{
  GetImplementation( *this ).AckConfigure();
}
