...
bool Object::OnTouched( Actor actor, const TouchEvent& touchEvent )
{
  ...
  switch( point.state )
  {
    case TouchPoint::Down:
    {
      ...
      DALI_LOG_INFO( gPepperObjectLogging, Debug::Verbose, "Object::OnTouched: Touch Down (%.2f, %2.f) device = %d surface = %p\n", point.local.x, point.local.y, point.deviceId, mSurface );
      return true;
    }
    case TouchPoint::Up:
    {
      ...
      DALI_LOG_INFO( gPepperObjectLogging, Debug::Verbose, "Object::OnTouched: Touch Up (%.2f, %2.f) surface = %p\n", point.local.x, point.local.y, mSurface );
      return true;
    }
