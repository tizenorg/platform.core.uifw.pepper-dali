#ifndef __PEPPER_DALI_OUTPUT_H__
#define __PEPPER_DALI_OUTPUT_H__
...
class DALI_IMPORT_API Output : public BaseHandle
{
public:
...
public: //Signals
  ...
  typedef Signal< void ( Output, Toolkit::ImageView ) > OutputSignalType;

  OutputSignalType& ObjectAddedSignal();
  OutputSignalType& ObjectDeletedSignal();
...
#endif // __PEPPER_DALI_OUTPUT_H__
