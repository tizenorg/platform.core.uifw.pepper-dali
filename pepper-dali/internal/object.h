#ifndef __PEPPER_DALI_OBJECT_H__
#define __PEPPER_DALI_OBJECT_H__
...
class DALI_IMPORT_API Object : public BaseHandle
{
public:
...
public: //Signals
  ...
  typedef Signal< void ( Object, Toolkit::ImageView ) > ObjectSignalType;

  ObjectSignalType& AddedSignal();
  ObjectSignalType& DeletedSignal();
...
#endif // __PEPPER_DALI_OBJECT_H__
